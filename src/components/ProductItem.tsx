...
export default function ProductItem({ name, price, description, image_url, id }: ProductItemProps) {
  ...
  return (
    <>
      <div 
        className='flex justify-between items-start gap-2 py-4 md:px-4 md:border rounded-sm md:shadow-sm cursor-pointer hover:border-[#717171] transition' 
